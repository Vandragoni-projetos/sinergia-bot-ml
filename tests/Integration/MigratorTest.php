...
final class MigratorTest extends DatabaseTestCase
{
    public function testMigrationCreatesExpectedTablesAndIsIdempotent(): void
    {
        ...
        self::assertSame([
            ...
            'ml_product_offers', 'ml_products', 'ml_ranking_entries', 'ml_ranking_snapshots', 'niches', 'offer_selection_runs', 'schema_migrations', 'subniche_categories', 'subniches', 'user_sessions', 'users',
        ], $tables);
        ...
        self::assertSame(['0001', '0002', '0003', '0004', '0005', '0006', '0007'], $pdo->query('SELECT version FROM schema_migrations ORDER BY version')->fetchAll(\PDO::FETCH_COLUMN));
    }
    ...
    public function testDatabaseWithOnly0001IsUpgradedTo0002(): void
    {
        ...
        try {
            ...
            self::assertSame(['0002', '0003', '0004', '0005', '0006', '0007'], (new Migrator($pdo, $migrations))->migrate());
