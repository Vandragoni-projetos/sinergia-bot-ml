...
final class MigratorTest extends DatabaseTestCase
{
    public function testMigrationCreatesExpectedTablesAndIsIdempotent(): void
    {
        ...
        self::assertSame([
            ...
            'affiliate_media_declarations', 'destination_subniches', 'destinations', 'discovery_run_entries', 'discovery_runs', 'installations',
        ...
        self::assertSame(['0001', '0002', '0003', '0004', '0005', '0006', '0007', '0008', '0009', '0010'], $pdo->query('SELECT version FROM schema_migrations ORDER BY version')->fetchAll(\PDO::FETCH_COLUMN));
    }
    ...
    public function testDatabaseWithOnly0001IsUpgradedTo0002(): void
    {
        ...
        try {
            ...
            self::assertSame(['0002', '0003', '0004', '0005', '0006', '0007', '0008', '0009', '0010'], (new Migrator($pdo, $migrations))->migrate());
